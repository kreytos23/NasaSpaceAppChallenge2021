...
var style_Dcoup_2 = function(feature, resolution){
    ...
    if (value >= 3828.125000 && value <= 4081.625000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4081.625000 && value <= 4335.125000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 11.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4335.125000 && value <= 4588.625000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 11.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4588.625000 && value <= 4842.125000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 11.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4842.125000 && value <= 5095.625000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 11.2 + size,
