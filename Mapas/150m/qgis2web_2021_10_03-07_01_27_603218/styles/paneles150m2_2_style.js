...
var style_paneles150m2_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Wh/dia");
    var labelText = "";
    size = 0;
    ...
    if (value >= 2296.875000 && value <= 2448.975000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2448.975000 && value <= 2601.075000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2601.075000 && value <= 2753.175000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2753.175000 && value <= 2905.275000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2905.275000 && value <= 3057.375000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
