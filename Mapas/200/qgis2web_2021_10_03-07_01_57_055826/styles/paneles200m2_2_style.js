...
var style_paneles200m2_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 3062.500000 && value <= 3265.300000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3265.300000 && value <= 3468.100000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3468.100000 && value <= 3670.900000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3670.900000 && value <= 3873.700000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3873.700000 && value <= 4076.500000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
